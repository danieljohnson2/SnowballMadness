 ...
 * air blocks. I'm thinking, boat for water blocks, smooth halfslabs for 
 * slabs-in-the-air, minecart for 'girders'. The latter might be LinkedTrail
 * and fill in the gaps that would exist in a 'fence' placement, in the event
 * of a corner-to-corner transition. The idea is, sparse is ones that can be
 * more scattered (stepping stones, water pillars, scorched earth).
 * 
